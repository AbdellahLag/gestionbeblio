...
<link rel="stylesheet" href="../CSS/theme.css"/>
  <title>BiblioAbdel</title>
<body>
<div class="jumbotron">
      <div class="col-lg-8">
          <span class="biblio-logo">BiblioAbdel<span class="dot"></span></span>
      </div>
      <div class="col-lg-4">
    ...
    <div class="col-lg-4">
      <div class="team">        
        <ul>
          ...
          <li><a herf="#">Abdellah Laghzaoui</a></li>
          <li><a herf="#">Aymane el malki cherkaoui</a></li>
        </ul>
      </div>  
    </div>
</div>
<div class="rights" >
  © 2023 copyrights to <span class="italic"></span>
</div>
